...
export default function Register() {
  ...
  const s: Record<string,React.CSSProperties> = {
    ...
    title:{fontSize:'22px',fontWeight:800 as any,marginBottom:'16px',textAlign:'center' as any,color:'#f0f2f8'},
    planBadge:{background:'rgba(0,208,132,.1)',border:'1px solid rgba(0,208,132,.2)',color:'#00d084',padding:'8px 14px',borderRadius:'8px',fontSize:'12px',marginBottom:'16px',textAlign:'center' as any},
